...
if (isset($_POST['enviar'])) {
  ...
  if (isset($_POST['fecha_inicio']) && ! empty($_POST['fecha_inicio'])) {
    $fechaInicioSeleccionada = $_POST['fecha_inicio'];
  }
  else {
    $msg_error = "Debe seleccionar la fecha de inicio de rango.";
  }

  if (isset($_POST['fecha_final']) && ! empty($_POST['fecha_final'])) {
    $fechaFinalSeleccionada = $_POST['fecha_final'];
  }
  else {
    $msg_error = "Debe seleccionar la fecha final de rango.";
  }
...
?>
  ...
  <div class="container">
    ...
    <div class="page-header">
      <h2>SMS <small>Notificación de faltas de asistencia</small></h2>
    </div>
    ...
    <div class="well">
      <form action="asistencias.php" method="post">
        <fieldset>
          <legend>Notificación de faltas de asistencia</legend>
          ...
          <div class="row">
            ...
            <div class="col-sm-7">
              ...
              <div class="form-group">
                <label for="causa">Rango de inicio</label>
