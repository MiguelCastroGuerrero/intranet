							...
							<div class="row">
								<div class="col-sm-7">
									<div class="form-group">
									  ...
									  <?php $result = mysqli_query($db_con, "SELECT DISTINCT APELLIDOS, NOMBRE, claveal FROM alma WHERE unidad='".$_SESSION['mod_tutoria']['unidad']."' ORDER BY APELLIDOS, NOMBRE ASC"); ?>
					...
					if ($row = mysqli_fetch_array($result)) {
						...
						do{
						  ...
						  $fecha3 = "$dia3[2]-$dia3[1]-$dia3[0]";
							...
							<a href='intervencion.php?id=$row[6]' data-bs='tooltip' title='Ver informe'><i class='fas fa-search fa-lg fa-fw'></i></a>
							</td></tr>";
						}
