    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-offset-2 col-md-8">
                ...
                <ol>
                    <li>El <?php echo $config['centro_denominacion']; ?> pone a disposición del personal docente y no docente del mismo la Web (<?php echo $config['dominio']; ?>/intranet/).</li>
                ...
                <ol>
                    ...
                    <li>La existencia de un hiperenlace entre una página web y <?php echo $config['dominio']; ?> no implica la existencia de relaciones entre el <?php echo $config['centro_denominacion']; ?> y el propietario de esa página, ni la aceptación y aprobación de sus contenidos y servicios.</li>
                ...
                <p>Secretaría General Técnica de la Consejería de Desarrollo Educativo y Formación Profesional de la Junta de Andalucía, con dirección en Avda. Juan Antonio de Vizarrón, s/n, Edificio Torretriana. 41071, Sevilla.</p>
                ...
                <?php if (isset($_SESSION['pagina_centro']) && $_SESSION['pagina_centro'] == 1): ?>
                <p>Cuando accede a la página de <a href="//<?php echo $config['dominio']; ?>/alumnado/" target="_blank">Alumnado</a> para consultar la información académica, se recopilan la dirección de correo electrónico y número de teléfono móvil, con el fin de poder actualizar o combinar la información de contacto ofrecida por el alumno o tutores legales en la matrícula para enviar notificaciones vía SMS o correo eléctronico.</p>
                <?php endif; ?>

                <p>Cuando accede a la <a href="//<?php echo $config['dominio']; ?>/intranet/">Intranet</a> se recopilan la dirección de correo electrónico y número de teléfono móvil, con el fin de poder enviar notificaciones vía SMS o correo eléctronico.</p>
                ...
                <h5>6.1. Cómo gestionar las Cookies en su equipo: la desactivación y eliminación de las cookies</h5>
