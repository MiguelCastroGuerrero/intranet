...
<ul class="nav nav-tabs">
	<li><a
		...
		class="fas fa-plus-circle fa-fw"></i> Nueva columna de datos</a></li>
	...
	<li><!-- Button trigger modal --> <a href="#" class="pull-right"
		...
		class="fas fa-columns fa-fw"></i> Operaciones con las Columnas </a> <!-- Modal -->
	...
	if (mysqli_num_rows($colum0) > 0) {
		...
		while($colum00=mysqli_fetch_array($colum0)){
			...
			while ($colum1 = mysqli_fetch_array($otra2)) {
				...
				$colum1[3] ? $icon_lock = '<i class="fas fa-lock" data-bs="tooltip" title="Columna oculta en el Cuaderno"></i>' : $icon_lock  = '';
